...
// Pattern used for this app: Multiple Producer - Multiple consumer.
...
func main() {
	...
	reserverdOrderCh := reserveInventory(validOrderCh) // multiple Producers wg.WaitGroup apply.
	fillOrders(reserverdOrderCh, &wg) // Multiple Consumers wg.WaitGroup apply.
...
// This will be the end of the execution.  Multiple Consumer function. 
